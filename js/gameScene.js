...
class GameScene extends Phaser.Scene {
    ...
    createDot () {
      ...
      const Dot = this.physics.add.sprite(dotXLocation, -100, "dot").setScale(0.05)
    ...
    createGhost () {
      ...
      const Ghost = this.physics.add.sprite(ghostXLocation, -100, "ghost").setScale(0.35)
   ...
   create(data) {
     ...
     this.ship = this.physics.add.sprite(1920 / 2, 1080 - 100, "ship").setScale(0.175)
    ...
    this.physics.add.collider(this.ship, this.dotGroup, function (shipCollide, dotCollide){
      dotCollide.destroy()
      this.sound.play("eat")
    ...
    this.physics.add.collider(this.ship, this.ghostGroup, function (shipCollide, ghostCollide) {
